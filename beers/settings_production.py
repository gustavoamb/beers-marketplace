...
ALLOWED_HOSTS = ["localhost", os.getenv("DJANGO_HOST"), "10.0.0.121", "10.0.0.100"]
...
GS_BUCKET_NAME = "customers_media"
GS_CREDENTIALS = service_account.Credentials.from_service_account_file(
    os.path.join(
        BASE_DIR, os.getenv("GOOGLE_CLOUD_STORAGE_SERVICE_ACCOUNT_CREDENTIALS", "")
    )
)
DATA_UPLOAD_MAX_MEMORY_SIZE = 26214400
FILE_UPLOAD_MAX_MEMORY_SIZE = 20971520  # 13 MB
...
CELERY_BEAT_SCHEDULE = {
    "expire_purchases": {
        "task": "stores.tasks.expire_purchases",
